const Education = () => {
    return (
    <>
        <h1 className="text-2xl sm:text-4xl text-center" id="edu">Education</h1>
            <div className="flex flex-col gap-5">
                ...
                <div className="md:flex">
                    ...
                    <div className="p-8">
                    <a href='https://www.usc.edu' className="hover:underline"><div className="uppercase tracking-wide text-sm text-indigo-500 font-semibold">University of Southern California</div></a>
                ...
                <div className="md:flex">
                    <div className="md:shrink-0 flex flex-row items-center">
                        <a href="https://www-en.ntut.edu.tw">
